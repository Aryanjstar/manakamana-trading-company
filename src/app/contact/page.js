        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 shadow-sm">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <a
                  href="tel:8299200015"
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-white text-sm font-semibold rounded-lg hover:bg-primary-dark transition-colors"
                >
          ...
          <div>
            ...
            <div className="rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-slate-700">
              <iframe
                src="https://www.google.com/maps?q=Brijmanganj+Shahabad+Uttar+Pradesh+273157&output=embed"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="मनोकामना ट्रेडिंग कम्पनी - बृजमनगंज"
              />
            </div>
