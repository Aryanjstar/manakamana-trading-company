...
const userSlice = createSlice({
    ...
    reducers: {
        ...
        // RENAMED THIS ACTION FROM authLogout to logoutUser
        logoutUser: (state) => {
            ...
            state.error = null;
            state.response = null; // Set to null instead of true for consistency
...
export const {
    ...
    authFailed,
    authError,
    logoutUser, // EXPORTING the renamed action
    isTokenValid,
    getDeleteSuccess,
    getRequest,
    productSuccess,
